...
import {
    Users, Activity, User, AlertTriangle, Map, ShieldAlert,
    Search, Bell, Stethoscope, LogOut, ChevronDown, ChevronRight, LayoutGrid
} from "lucide-react";
        ...
        <div className="flex h-screen bg-[#F8FAFC] font-sans text-gray-800">
            ...
            <aside className="w-56 bg-white flex flex-col transition-all z-20 flex-shrink-0 border-r border-gray-200">
                ...
                <nav className="flex-1 px-3 py-1 space-y-1">
                    ...
                    {/* Dashboard */}
                    <NavLink to="/user" end className={linkStyle}>
                        {({ isActive }) => (
                            <>
                    ...
                    <NavLink to="/user/disease-information" end className={linkStyle}>
                        {({ isActive }) => (
                            <>
                                <Stethoscope size={18} strokeWidth={isActive ? 2.5 : 2} />
                                <span className="text-[13px] whitespace-nowrap">Thông tin bệnh dịch</span>
                            </>
                        )}
                    </NavLink>
                </nav>
